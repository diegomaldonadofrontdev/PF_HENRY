...
const getproductsCategoriesHandler = async (req, res) => {
	// OK
	try {
...
const putRestStockHandler = async (req, res) => {
	// OK.
	...
	try {
		for (let i = 0; i < products.length; i++) {
			...
			if (!descount)
				res.status(200).json(`Uno o mas productos no se actualizaron.`);
		}
...
const putAddStockHandler = async (req, res) => {
	// OK.
