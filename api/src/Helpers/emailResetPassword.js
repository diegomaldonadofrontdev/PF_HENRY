                                    ...
                                    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                        <tr>
                                            <td style="padding:0 0 36px 0;color:#153643;">
                                                ...
                                                <p style="margin:0;font-size:16px;line-height:24px"><a href="https://pf-henry-two.vercel.app/resetpassword2/${token}" style="color:#ff441f;text-decoration:underline;">Crea tu nueva contraseña</a></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
