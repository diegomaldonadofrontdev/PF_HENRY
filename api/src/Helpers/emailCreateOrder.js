...
const sendMailOrder = async(email,firstName,lastName,productos,orden, total) => {
    const config = {
        host: "smtp.gmail.com",
        port: 587,
        auth :{ 
                                    ...
                                    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                        <tr>
                                            <td style="padding:0 0 36px 0;color:#153643;">
                                                ...
                                                <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;">Compraste los siguientes productos ${productos} por un total de $${total}, espera las indicaciones del comercio para poder recibirlo, tu numero de orden es: ${orden}</p>
