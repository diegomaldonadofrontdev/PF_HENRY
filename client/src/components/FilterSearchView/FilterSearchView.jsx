...
export default function FilterSearchView() {
  ...
  return (
    <div className={styles.filterSearchView}>
      <form action="" className={styles.form__filterCategory}>
        <div>
          <p className={styles.filters__p}>Filtrar por Categoria:</p>
          <select
            name="category"
            onChange={(e) => {
              formHandlerChange(e);
        ...
        {tradesSubCategories.length > 0 && filters.category !== "default" ? (
          <div>
            <p className={styles.filters__p}>Agregar Subcategoria:</p>
            <select
              name="subcategory"
              onChange={(e) => {
                formHandlerChange(e);
        ...
        <div>
          <p className={styles.filters__p}>Filtrar por Zona:</p>
          <select
            name="zone"
            onChange={(e) => {
              formHandlerChange(e);
        ...
        <div>
          <p className={styles.filters__p}>Filtrar por Medio de pago:</p>
          <select
            name="epagos"
            onChange={(e) => {
              formHandlerChange(e);
